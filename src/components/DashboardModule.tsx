...
export const DashboardModule: React.FC<DashboardModuleProps> = ({ onNavigate, currentUser }) => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Special Water Surveillance Quick Alert Banner (User Request 3) */}
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs shadow-md transition-all active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded-lg bg-teal-600 hover:bg-teal-500 text-white font-bold text-xs shadow-md transition-all active:scale-95 border border-teal-400/40"
            >
              <Droplets className="w-3.5 h-3.5" />
              <span>उपकेंद्रनिहाय मासिक यादी ({monthlyWaterPlan.overall.totalSources} स्रोत)</span>
            </button>
          </div>
        </div>
      </div>
